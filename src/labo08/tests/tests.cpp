...
TEST(subsecuenciaTest, s1Invertido){
    ASSERT_FALSE(subsecuencia("asds", "sdsa"));
}

TEST(subsecuenciaTest, NoCompartenLetras){
    ASSERT_FALSE(subsecuencia("asds", "cbtrlmp"));
}

TEST(subsecuenciaTest, DosPalabras){
    ASSERT_TRUE(subsecuencia("cbtrl", "cbtr lmp"));
}
/////////////////////////// agruparAnagramas ///////////////////////////
