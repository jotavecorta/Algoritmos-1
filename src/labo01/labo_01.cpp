...
/** fibonacciIterativa: Recibe un entero (n) y devuelve otro entero correspondiente
 al n-esimo término de la serie de Fibonacci, de modo iterativo.*/
...
int main() {
    ...
    // Fibonacci Recursivo
    std::cout << "- El término número " << n << " de la serie de Fibonacci -recursivo- es: ";
    std::cout << fibonacciRecursiva(n) << std::endl;

    // Fibonacci Iterativo
    std::cout << "- El término número " << n << " de la serie de Fibonacci -iterativo- es: ";
